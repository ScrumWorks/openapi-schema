...
class ValueValidatorValidateTest extends TestCase
{
    ...
    public function dpTestArray(): array
    {
        return [
            ...
            'array:valid-null' => [new ArraySchema(itemsSchema: new IntegerSchema(), nullable: true), null, []],
            ...
            'array:minItems' => [
                new ArraySchema(itemsSchema: new IntegerSchema(), minItems: 4),
                [1],
                [[1005, 'Items count has to be at least %d.', [4], '']],
            ],
            'array:maxItems' => [
                new ArraySchema(itemsSchema: new IntegerSchema(), maxItems: 1),
                [1, 2],
                [[1006, 'Items count has to be at most %d.', [1], '']],
            ],
            'array:unique' => [
                new ArraySchema(itemsSchema: new IntegerSchema(), uniqueItems: true),
                [1, 2, 2],
    ...
    public function dpTestFloat(): array
    {
        return [
            ...
            'float:valid-null' => [new FloatSchema(nullable: true), null, []],
            'float:valid-min' => [new FloatSchema(minimum: 3.0), 3.0, []],
            'float:valid-ex-min' => [new FloatSchema(minimum: 3.0), 5.0, []],
            'float:valid-max' => [new FloatSchema(maximum: 3.0), 3.0, []],
            'float:valid-ex-max' => [new FloatSchema(maximum: 3.0), 2.0, []],
            'float:valid-multipleOf' => [new FloatSchema(multipleOf: 2.3), 4.6, []],
            ...
            'float:max' => [
                new FloatSchema(maximum: 1.0),
                1.5,
                [[1011, 'Value has to be less or equal then %s.', ['1'], '']], ],
            'float:ex-max' => [
                new FloatSchema(maximum: 1.0, exclusiveMaximum: true),
                1.5,
                [[1012, 'Value has to be less then %s.', ['1'], '']],
            ],
            'float:multipleOf' => [
                new FloatSchema(multipleOf: 2.3),
                5.5,
    ...
    public function dpTestInteger(): array
    {
        return [
            ...
            'int:valid-null' => [new IntegerSchema(nullable: true), null, []],
            'int:valid-min' => [new IntegerSchema(minimum: 3), 3, []],
            'int:valid-ex-min' => [new IntegerSchema(minimum: 3, exclusiveMinimum: true), 5, []],
            'int:valid-max' => [new IntegerSchema(maximum: 3), 3, []],
            'int:valid-ex-max' => [new IntegerSchema(maximum: 3, exclusiveMaximum: true), 2, []],
            ...
            'int:ex-max' => [
                ...
                [[1012, 'Value has to be less then %s.', ['1'], '']], ],
            'int:multipleOf' => [
                new IntegerSchema(multipleOf: 2),
                5,
    ...
    public function dpTestString(): array
    {
        return [
            ...
            'string:valid-null' => [new StringSchema(nullable: true), null, []],
            'string:valid-minLength-equal' => [new StringSchema(minLength: 1), 'a', []],
            ...
            'string:pattern' => [
                new StringSchema(pattern: '-[0-9]{3}'),
                '2020-12-30',
